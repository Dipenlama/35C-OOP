...
public class Hello {
    public static void main(String[] args) {
       ...
       /* 2. Extend/Modify the above program to print two additional lines:
        ...
        A System.out.println statement has ( and ) and usually a String that starts and ends with a " 
        character.
        ...
        System.out.println("A System.out.println statement has (and) and usually a string that starts that starts and end with a \" " );
        System.out.println("character");
        System.out.println("(But we type \\\" instead!)");
        System.out.println("What is the difference between");
        System.out.println("a ' and a \"? Or between a \" and a \\\"?");
        System.out.println ("One is what we see when we're typing our program. The other is what appers on  the \"console.\"");
